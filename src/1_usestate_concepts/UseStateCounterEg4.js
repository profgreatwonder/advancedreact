...
const UseStateCounterEg = () => {
	...
	// here we want to work with complex counter where we will be working with setTimeout(which takes 2 parameter, (i) a callback function which is going to run in a certain amount of time and (ii). the amount of time to delay)
